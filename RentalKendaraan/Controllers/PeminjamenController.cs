...
namespace RentalKendaraan.Controllers
{
    public class PeminjamenController : Controller
    {
        ...
        {
            ViewData["IdCustomer"] = new SelectList(_context.Customer, "IdCustomer", "Alamat");
            ViewData["IdJaminan"] = new SelectList(_context.Jaminan, "IdJaminan", "NamaJaminan");
            ViewData["IdKendaraan"] = new SelectList(_context.Kendaraan, "IdKendaraan", "Ketersediaan");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("IdPeminjaman,TglPeminjaman,IdKendaraan,IdCustomer,IdJaminan,Biaya")] Peminjaman peminjaman)
        {
            ...
            ViewData["IdCustomer"] = new SelectList(_context.Customer, "IdCustomer", "Alamat", peminjaman.IdCustomer);
            ViewData["IdJaminan"] = new SelectList(_context.Jaminan, "IdJaminan", "NamaJaminan", peminjaman.IdJaminan);
            ViewData["IdKendaraan"] = new SelectList(_context.Kendaraan, "IdKendaraan", "Ketersediaan", peminjaman.IdKendaraan);
            return View(peminjaman);
        }
